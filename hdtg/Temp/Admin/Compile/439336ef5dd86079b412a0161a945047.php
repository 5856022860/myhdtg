...
<link href="http://example.houdunwang.com/hdzy/hdtg/group/hdtg/App/Admin/Tpl/Public/css/base.css" type="text/css" rel="stylesheet">
<link href="http://example.houdunwang.com/hdzy/hdtg/group/hdtg/App/Admin/Tpl/Public/css/index.css" type="text/css" rel="stylesheet">
<link href="http://example.houdunwang.com/hdzy/hdtg/group/hdtg/App/Admin/Tpl/Public/css/reset.css" type="text/css" rel="stylesheet">
...
<script	type="text/javascript" src="http://example.houdunwang.com/hdzy/hdtg/group/hdtg/App/Admin/Tpl/Public/js/index.js"></script>
...
<div id="header">
	<div class='hd-box'>
		<div class='hd-top'>
			<div class="logo">
				<a href="http://example.houdunwang.com/hdzy/hdtg/group/index.php/Admin"><img src="http://example.houdunwang.com/hdzy/hdtg/group/hdtg/App/Admin/Tpl/Public/images/logo.png"/></a>
			</div>
			<div class='logout'>
				<a style='color:#FFF;' target="_self" href="http://example.houdunwang.com/hdzy/hdtg/group">站点主页</a>
				<a target="_self" href="<?php echo U('Admin/Login/logout');?>">退出登录</a>
			</div>
		</div>
		<div class='bar'>
			<div class='home'>
				<a href="http://example.houdunwang.com/hdzy/hdtg/group/index.php/Admin"></a>
			</div>
			<div class="nav">
...
<div id="box">
	...
	<div id="content">
		 <iframe id="iContent" name='showContent' scrolling="auto" height="100%" width="100%" frameborder="0" src="http://example.houdunwang.com/hdzy/hdtg/group/index.php/Admin/Index/welcome" >
