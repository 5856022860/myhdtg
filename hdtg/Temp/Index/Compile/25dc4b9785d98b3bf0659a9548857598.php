...
<link href="http://example.houdunwang.com/hdzy/hdtg/Public/css/reset.css" type="text/css" rel="stylesheet" >
<link href="http://example.houdunwang.com/hdzy/hdtg/Public/css/common.css" type="text/css" rel="stylesheet" >
<script type='text/javascript' src='http://example.houdunwang.com/hdzy/hdtg/hdphp/Extend/Org/Jquery/jquery-1.8.2.min.js'></script>
<script type="text/javascript" src="http://example.houdunwang.com/hdzy/hdtg/Public/js/common.js"></script>
...
<body>
	...
	<div id="header">
		<div class='position'>
			<div class='logo'>
				<a style="line-height:60px;" href="http://example.houdunwang.com/hdzy/hdtg">后盾团购</a>
				<a style="font-size:16px;" href="http://example.houdunwang.com/hdzy/hdtg">www.houdunwang.com</a>
			</div>
			<div class='search'>
				<div class='item'>
	...
	<div id="nav">
		<div class='position'>
			<!-- 分类相关 -->
			<div class='category'>
				<a category=-1  href="http://example.houdunwang.com/hdzy/hdtg">首页</a>
...
<!-- 载入公共头部文件结束 -->
	<link href="http://example.houdunwang.com/hdzy/hdtg/hdtg/App/Index/Tpl/Public/css/detail.css" type="text/css" rel="stylesheet" >
	...
	<script src="http://example.houdunwang.com/hdzy/hdtg/hdtg/App/Index/Tpl/Public/js/detail.js"> </script>
	<script>
